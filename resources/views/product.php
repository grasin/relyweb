		...
		<div class="col-md-6">
			...
			<div class="order">
				<?php if ($product->quantity > 0) { ?>
					...
					<button class="add-wishlist bg" data-id="<?=$product->id?>"><?=(!array_key_exists($product->id, (request()->cookie('wishlist') != null ? json_decode(stripslashes(request()->cookie('wishlist')),true) : array())) ? translate('Add to wishlist') : translate('Remove from wishlist') )?></button>
				<?php } else { ?>
