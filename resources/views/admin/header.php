				...
				<nav class="navbar navbar-inverse">
					<div>
						<div class="navbar-header">
							...
							<a class="navbar-brand" href="#"><img src="<?=url('assets/logo_white.png')?>"></a>
						</div>
						<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="sidebar-menu">
								...
								<li hidden <?=($area == "blog" ? "class=active" : "")?>><a href="blog"><i class="icon-docs"></i> <span>Blog</span></a></li>
								<li <?=($area == "customers" ? "class=active" : "")?>><a href="customers"><i class="icon-docs"></i> <span>Customers</span></a></li>
								<li hidden <?=($area == "coupons" ? "class=active" : "")?>><a href="coupons"><i class="icon-present"></i> <span>Coupons</span></a></li>
								<li hidden <?=($area == "reviews" ? "class=active" : "")?>><a href="reviews"><i class="icon-speech"></i> <span>Reviews</span></a></li>
								<li class="header">Sales</li>
								<li <?=($area == "orders" ? "class=active" : "")?>><a href="orders"><i class="icon-basket"></i> <span>Orders</span></a></li>
								<li <?=($area == "rfqs" ? "class=active" : "")?>><a href="rfqs"><i class="icon-basket"></i> <span>RFQs</span></a></li>
								<li hidden <?=($area == "statistics" ? "class=active" : "")?>><a href="statistics"><i class="icon-bar-chart"></i> <span>Statistics</span></a></li> 
								...
								<li hidden <?=($area == "payment" ? "class=active" : "")?>><a href="payment"><i class="icon-credit-card"></i> <span>Payment</span></a></li>
								...
								<li hidden <?=($area == "tokens" ? "class=active" : "")?>><a href="tokens"><i class="icon-key"></i> <span>API Tokens</span></a></li>
